    ...
    return (
      ...
      <section id="signUp">
        ...
        <div style={{  width: '100%' , paddingLeft: '15px', paddingRight: '15px'}}>
          ...
          <Row>
            <Col>
              <Button block color="secondary" style={{ width: '100px', padding: '0', backgroundColor: '#74818F', borderRadius: '4px', height: '34px', float: 'right'}} id="" onClick={this.back}>No</Button>
            </Col>
            <Col>
